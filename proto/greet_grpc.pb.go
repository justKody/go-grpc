...
const (
	...
	GreetService_SayHelloServerStreaming_FullMethodName        = "/GreetService/SayHelloServerStreaming"
	GreetService_SayHelloClientStreaming_FullMethodName        = "/GreetService/SayHelloClientStreaming"
...
type GreetServiceClient interface {
	...
	SayHelloServerStreaming(ctx context.Context, in *HelloResponse, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error)
...
func (c *greetServiceClient) SayHelloServerStreaming(ctx context.Context, in *HelloResponse, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type GreetServiceServer interface {
	...
	SayHelloServerStreaming(*HelloResponse, grpc.ServerStreamingServer[HelloResponse]) error
...
func (UnimplementedGreetServiceServer) SayHelloServerStreaming(*HelloResponse, grpc.ServerStreamingServer[HelloResponse]) error {
...
func _GreetService_SayHelloServerStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreetServiceServer).SayHelloServerStreaming(m, &grpc.GenericServerStream[HelloResponse, HelloResponse]{ServerStream: stream})
}
